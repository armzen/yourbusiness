...
<div class="body-content">
    <div id="mySidenav" class="sidenav">
        ...
        <ul class="nav"> <!--nav-tabs -->
            <li class='menu-items'>
                <a class='page-scroll' href="<?= Url::to(['home/index', 'lng' => $lng]) ?>">
                    Home
                </a>
            </li>
            <li class='menu-items'>
                <a class='page-scroll' href="<?= Url::to(['home/index','#'=>'about', 'lng' => $lng]) ?>">
                    About Us
                </a>
            </li>
    ...
    <header id="header">
        <h1>
            <a href="<?= Url::to(['home/index', 'lng' => $lng]) ?>">
                Your Business
            </a>
        </h1>
    ...
    <div class="lang-bar">
        <a href="<?= Url::to(['home/index', 'lng' => 1]) ?>" >arm</a>
        <a href="<?= Url::to(['home/index', 'lng' => 2]) ?>" >eng</a>
        <a href="<?= Url::to(['home/index', 'lng' => 3]) ?>" >rus</a>
    </div>
